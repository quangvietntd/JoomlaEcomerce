...
define( 'URL', 'http://localhost/zeolite/' );
define( 'SECUREURL', 'http://localhost/zeolite/' );

if ( @$_SERVER['HTTPS'] == 'on' ) {
	define( 'IMAGEURL', SECUREURL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', SECUREURL.'components/com_virtuemart/themes/ja-zeolite/' );
} else {
	define( 'IMAGEURL', URL .'components/com_virtuemart/shop_image/' );
	define( 'VM_THEMEURL', URL.'components/com_virtuemart/themes/ja-zeolite/' );
}
define( 'VM_THEMEPATH', $mosConfig_absolute_path.'/components/com_virtuemart/themes/ja-zeolite/' );
...
define('DOWNLOADROOT', 'E:\\localhost\\www\\ja_works\\ja_zeolite/');
...
define('CHECK_STOCK', '');
define('ENCODE_KEY', '550e96c3ade8094db5b2a89a8eb86611');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
