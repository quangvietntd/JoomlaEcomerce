...
/**
*
* @version $Id: ps_order_edit.php 1132 2008-01-08 14:50:07Z soeren_nb $
* @author nfischer
...
class ps_order_edit {
	...
	**************************************************************************/
	...
	function delete_product() {
		...
		$vmLogger->info( $VM_LANG->_('VM_ORDER_EDIT_PRODUCT_DELETED',false) );
	}
	...
	function update_quantity() {
		...
		$vmLogger->info( $VM_LANG->_('VM_ORDER_EDIT_QUANTITY_UPDATED',false) );
	...
	function list_products($product_id) {
		...
		$display .= '<option value="-1">' . $VM_LANG->_('VM_ORDER_EDIT_CHOOSE_PRODUCT') . '</option>';
