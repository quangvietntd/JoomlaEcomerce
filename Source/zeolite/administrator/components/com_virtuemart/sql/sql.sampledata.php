...
/**
*
* @version $Id: sql.sampledata.php 1181 2008-01-24 16:07:09Z gregdev $
* @package VirtueMart
* @subpackage core
...
$db->query( "INSERT INTO `#__{vm}_category` VALUES (1, 1, 'Hand Tools', 'Hand Tools', 'ee024e46399e792cc8ba4bf097d0fa6a.jpg', 'fc2f001413876a374484df36ed9cf775.jpg', 'Y', 950319905, 960304194, 'browse_3', '3', '', '1');");
$db->query( "INSERT INTO `#__{vm}_category` VALUES (2, 1, 'Power Tools', 'Power Tools', 'fc8802c7eaa1149bde98a541742217de.jpg', 'fe2f63f4c46023e3b33404c80bdd2bfe.jpg', 'Y', 950319916, 960304104, 'browse_4', '4', '', '2');");
$db->query( "INSERT INTO `#__{vm}_category` VALUES (3, 1, 'Garden Tools', 'Garden Tools', '702168cd91e8b7bbb7a36be56f86e9be.jpg', '756ff6d140e11079caf56955060f1162.jpg', 'Y', 950321122, 960304338, 'browse_2', '2', 'shop.garden_flypage', '3');");
$db->query( "INSERT INTO `#__{vm}_category` VALUES (4, 1, 'Outdoor Tools', 'Outdoor Tools', NULL, NULL, 'Y', 955626629, 958889528, 'browse_1', '1', NULL, '4');");
...
$db->query( "INSERT INTO `#__{vm}_product_attribute_sku` VALUES (2, 'Material', 1);");

$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (1, 1, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (3, 2, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (3, 3, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (3, 4, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (1, 5, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (1, 6, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (4, 7, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (2, 8, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (5, 9, NULL);");
$db->query( "INSERT INTO `#__{vm}_product_category_xref` VALUES (2, 10, NULL);");

$db->query( "INSERT INTO `#__{vm}_product_discount` VALUES (1, '20.00', 1, 1097704800, 1194390000);");
$db->query( "INSERT INTO `#__{vm}_product_discount` VALUES (2, '2.00', 0, 1098655200, 0);");

$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('1', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('2', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('3', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('4', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('5', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('6', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('7', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('8', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('9', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('10', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('11', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('12', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('13', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('14', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('15', '1');");
$db->query( "INSERT INTO `#__{vm}_product_mf_xref` VALUES  ('16', '1');");

$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (1, 5, '24.99', 'USD', 0, 0, 950321309, 950321309, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (2, 1, '4.99', 'USD', 0, 0, 950321324, 950321324, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (3, 2, '49.99', 'USD', 0, 0, 950321340, 950321340, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (4, 3, '24.99', 'USD', 0, 0, 950321368, 950321368, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (5, 4, '19.99', 'USD', 0, 0, 950321385, 950321385, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (6, 6, '1.00', 'USD', 0, 0, 950321686, 963808699, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (7, 7, '149.99', 'USD', 0, 0, 950321754, 966506270, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (8, 8, '220.90', 'USD', 0, 0, 950321833, 955614388, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (9, 9, '48.12', 'USD', 0, 0, 950321933, 950321933, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (10, 10, '74.99', 'USD', 0, 0, 950322005, 950322005, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (11, 1, '2.99', 'USD', 0, 0, 955626841, 955626841, 6, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (12, 13, '14.99', 'USD', 0, 0, 955697213, 955697213, 5, 0, 0);");
$db->query( "INSERT INTO `#__{vm}_product_price` VALUES (13, 14, '79.99', 'USD', 0, 0, 962351197, 962351271, 5, 0, 0);");
