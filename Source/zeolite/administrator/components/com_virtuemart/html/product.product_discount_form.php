...
/**
*
* @version $Id: product.product_discount_form.php 1095 2007-12-19 20:19:16Z soeren_nb $
* @package VirtueMart
* @subpackage html
...
<table class="adminform">
    ...
    <tr> 
      <td width="24%"><div align="right"><?php echo $VM_LANG->_('PHPSHOP_PRODUCT_DISCOUNT_AMOUNTTYPE') ?>:</div></td>
      <td width="76%"> 
    ...
    <tr> 
      <td width="24%"><div align="right"><?php echo $VM_LANG->_('PHPSHOP_PRODUCT_DISCOUNT_STARTDATE') ?>:</div></td>
      <td width="76%"> 
    ...
    <tr> 
      <td width="24%"><div align="right"><?php echo $VM_LANG->_('PHPSHOP_PRODUCT_DISCOUNT_ENDDATE') ?>:</div></td>
      <td width="76%"> 
