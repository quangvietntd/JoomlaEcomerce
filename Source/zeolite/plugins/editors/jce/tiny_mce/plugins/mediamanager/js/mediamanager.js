var MediaManagerDialog = {
	...
	insert : function(){
		...
		if(v === ''){
			new Alert(tinyMCEPopup.getLang('mediamanager_dlg.no_src', 'An URL is required. Please select an image or enter an URL'));
			return false;		
		}
		if(w === ''){
		...
		if(/(windowsmedia|mplayer|quicktime|divx)$/.test(t)){
