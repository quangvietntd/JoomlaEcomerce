...
if (!$alreadycommented) {
    ...
    <h3 class="vmFieldTitle"><?php echo $VM_LANG->_('PHPSHOP_WRITE_REVIEW')  ?></h3>
    ...
    <div class="chars-written"><?php echo $VM_LANG->_('PHPSHOP_REVIEW_COUNT')  ?>
    <input type="text" value="0" size="4" class="inputbox" name="counter" maxlength="4" readonly="readonly" />
    </div>
    <br />
    <input class="button" style="margin-top: 15px;" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" value="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" />
